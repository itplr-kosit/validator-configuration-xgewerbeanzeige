 ...
 * XGewerbeanzeige 1.3
 * XGewerbeanzeige 2.0
 * XGewerbeanzeige 2.1 (Final Proposal)
...
auspacken.
2. Die [Prüftool-Konfiguration XGewerbeanzeige](https://github.com/itplr-kosit/validator-configuration-xgewerbeanzeige/releases/download/release-2019-04-29/validator-configuration-xgewerbeanzeige_2019-04-29.zip) herunterladen und auspacken.
